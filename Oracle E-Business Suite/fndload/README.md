...
```
FNDLOAD apps/<$APPS_PWD> 0 Y DOWNLOAD $ALR_TOP/patch/115/import/alr.lct ALR_XXDL_ALERT_NAME.ldt ALR_ALERTS APPLICATION_SHORT_NAME="XXDL" ALERT_NAME="ALR_XXDL_ALERT_NAME"
```
