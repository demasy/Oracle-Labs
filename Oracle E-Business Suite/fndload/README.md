...
###### Download  
> FNDLOAD apps/xx_demasy_PWD 0 Y DOWNLOAD $ALR_TOP/patch/115/import/alr.lct XXCUST_ALERT.ldt ALR_ALERTS APPLICATION_SHORT_NAME="XXCUST" ALERT_NAME="XXCUST_ALERT"

###### Upload 
 
> FNDLOAD apps/xx_demasy_PWD 0 Y UPLOAD $ALR_TOP/patch/115/import/alr.lct XXCUST_ALERT.ldt CUSTOM_MODE=FORCE
...
> FNDLOAD apps/<APPS_PWD> O Y DOWNLOAD $FND_TOP/patch/115/import/afcpprog.lct XXCUST_CONCURRENT_PROGRAM.ldt PROGRAM APPLICATION_SHORT_NAME="XXCUST" CONCURRENT_PROGRAM_NAME="XXCUST_CONCURRENT_PROGRAM"

###### Upload

> FNDLOAD apps/<APPS_PWD> 0 Y UPLOAD $FND_TOP/patch/115/import/afcpprog.lct XXCUST_CONCURRENT_PROGRAM.ldt - WARNING=YES UPLOAD_MODE=REPLACE CUSTOM_MODE=FORCE
...
> FNDLOAD apps/<APPS_PWD> O Y DOWNLOAD $XDO_TOP/patch/115/import/xdotmpl.lct XXCUST_DATA_DEFINITION.ldt XDO_DS_DEFINITIONS APPLICATION_SHORT_NAME='XXCUST' DATA_SOURCE_CODE='XXCUST_SOURCE_CODE' TMPL_APP_SHORT_NAME='XXCUST' TEMPLATE_CODE='XXCUST_DATA_DEFINITION_CODE'

###### Upload

> FNDLOAD apps/<APPS_PWD> O Y UPLOAD $XDO_TOP/patch/115/import/xdotmpl.lct XXCUST_DATA_DEFINITION.ldt
